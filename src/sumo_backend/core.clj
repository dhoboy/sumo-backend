...
(defn get-data
  ...
  (start-data-pipeline)
  (cond
    (and year month day) (>!! fetch-chan date)
...
(def explain-sumo '(";; Sumo tournaments are 15 days.\n"
...
(def explain-data '(";; Data for this project\n"
...
(defn -main
  ;; runs as if you booted repl, runs main and calls with bash args as args
